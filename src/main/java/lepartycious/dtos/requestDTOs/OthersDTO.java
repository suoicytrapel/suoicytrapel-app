...
public class OthersDTO implements Serializable{
	...
	private List<Long> othersServices;
	...
	public Long getOthersType() {
		return othersType;
	}
	public void setOthersType(Long othersType) {
	...
	public List<Long> getOthersServices() {
		return othersServices;
	}
	public void setOthersServices(List<Long> othersServices) {
