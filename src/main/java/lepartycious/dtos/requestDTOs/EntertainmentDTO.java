...
public class EntertainmentDTO implements Serializable{
	
	private String name;
	private String description;
	private Long entertainmentType;
	...
	private List<Long> entertainmentServices;
	...
	public Long getEntertainmentType() {
		return entertainmentType;
	}
	public void setEntertainmentType(Long entertainmentType) {
	...
	public List<Long> getEntertainmentServices() {
		return entertainmentServices;
	}
	public void setEntertainmentServices(List<Long> entertainmentServices) {
